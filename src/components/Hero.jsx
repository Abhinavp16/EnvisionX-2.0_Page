            ...
            <div className="container">
                <div style={{
                    ...
                    >
                        ...
                        <p style={{ maxWidth: '600px', marginBottom: '3rem', color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: '1.6' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '0.8rem', opacity: 0.6, letterSpacing: '1px', textTransform: 'uppercase' }}>Registration Ends</div>
                                <div style={{ fontWeight: '700', fontSize: '1rem', color: 'var(--accent-primary)' }}>FEB 20</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
